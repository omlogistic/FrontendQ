...
const SalonDetails = () => {
  ...
  const STATIC_SERVICES = [
    ...
    { id: 3, name: 'Manicure', duration: '45 min', price: 40 },
    { id: 4, name: 'Pedicure', duration: '60 min', price: 50 },
    { id: 5, name: 'Facial', duration: '90 min', price: 120 },
  ];
